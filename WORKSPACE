...
http_archive(
    ...
    sha256 = "425d4e3e16e78b6614c80db402af3fa3e1a3fc1fdf69410c90c601c715bdb926",
    strip_prefix = "harfbuzz-4.1.0",
    urls = ["https://github.com/harfbuzz/harfbuzz/archive/4.1.0.zip"],
)
