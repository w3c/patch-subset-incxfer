...
class CborUtils {
 public:
  ...
  // not found.
  static absl::StatusCode GetField(const cbor_item_t& cbor_map,
                                   int field_number, cbor_item_unique_ptr& out);

  static absl::StatusCode GetUInt64Field(const cbor_item_t& map,
                                         int field_number,
                                         std::optional<uint64_t>& out);
  static absl::StatusCode GetFloatField(const cbor_item_t& map,
                                        int field_number,
                                        std::optional<float>& out);
  static absl::StatusCode GetStringField(const cbor_item_t& map,
                                         int field_number,
                                         std::optional<std::string>& out);
  static absl::StatusCode GetBytesField(const cbor_item_t& map,
                                        int field_number,
                                        std::optional<std::string>& out);
  ...
  static absl::StatusCode SetStringField(
      cbor_item_t& map, int field_number,
      const std::optional<std::string>& value);
  static absl::StatusCode SetBytesField(
      cbor_item_t& map, int field_number,
      const std::optional<std::string>& value);
  ...
  static absl::StatusCode DecodeInt(const cbor_item_t& int_element,
                                    int32_t* out);

  static cbor_item_t* EncodeUInt64(uint64_t n);
  static absl::StatusCode DecodeUInt64(const cbor_item_t& int_element,
                                       uint64_t* out);

  static cbor_item_t* EncodeFloat(float n);
  static absl::StatusCode DecodeFloat(const cbor_item_t& float_element,
                                      float* out);
